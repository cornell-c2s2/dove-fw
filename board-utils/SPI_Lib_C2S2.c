...
int reg_spimaster_wdata;
int reg_spimaster_control;
int reg_spimaster_status; 
char reg_spimaster_rdata; 
...
void array_read_spi(int* ptr, int size){ // size is num of samples to be collected
    //int data[size];
...
void run_spi()
{
    ...
    value = spi_read(); //single value read 
    void array_read_spi(int* ptr, int size) //Array Read, insert your own pointer and pointer size
